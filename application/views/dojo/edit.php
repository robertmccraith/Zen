...
<div id="content">
    <div class="wrap">        
        <form method="post" action="/dojo/edit" class="form-horizontal">
            <div id="main">
                <fieldset>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <div class="error-text"> <?php echo form_error($dojo_name['name']); ?><?php echo isset($errors[$dojo_name['name']])?$errors[$dojo_name['name']]:''; ?></div><p class="help-block"> Normally after an area, like <i>"Cork"</i> or multiple Dojos are in your area <i>"GitHub San Fran"</i></p>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                              <?=form_dropdown('country', $_countries, $dojo_data[0]->country, 'style = "width:270px;"');?>
